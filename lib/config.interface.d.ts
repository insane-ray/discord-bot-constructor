...
export declare type ActionType = 'simple' | 'mention' | 'text' | 'nested' | 'custom';
export declare type BotStateStatus = 'online' | 'idle' | 'dnd';
export declare type BotActivityType = 'PLAYING' | 'STREAMING' | 'LISTENING' | 'WATCHING';
